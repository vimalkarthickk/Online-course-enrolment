...
if(is_numeric(trim($seatlimit)) == false)
{
	$_SESSION['msg']="seatLimt should be numeric";
...
<div class="form-group">
    ...
    <input type="text" class="form-control" id="seatlimit" name="seatlimit" placeholder="Seat limit" pattern="[0-9]{10}" value="<?php echo htmlentities($row['noofSeats']);?>" required />
  </div>  
